...
var str2enum = require( './../../../../base/kmeans/algorithm-str2enum' );
...
tape( 'the function returns the string associated with a k-means clustering algorithm value', function test( t ) {
	var v;
	var i;
