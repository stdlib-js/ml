...
var enumeration = require( './../../../../base/kmeans/metrics' ).enum;
...
/**
* Returns the k-means distance metric string associated with a k-means distance metric enumeration constant.
*
* @param {integer} value - distance metric enumeration constant
* @returns {(string|null)} distance metric string or null
*
* @example
