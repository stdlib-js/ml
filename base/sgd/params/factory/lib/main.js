...
var resolvePenaltyStr = require( './../../../../../base/sgd/penalty-resolve-str' );
var resolveLRStr = require( './../../../../../base/sgd/learning-rate-resolve-str' );
var resolveLossFnStr = require( './../../../../../base/sgd/loss-function-resolve-str' );
...
var resolveLossFnEnum = require( './../../../../../base/sgd/loss-function-resolve-enum' );
var structFactory = require( './../../../../../base/sgd/params/struct-factory' );
var params2json = require( './../../../../../base/sgd/params/to-json' );
var params2str = require( './../../../../../base/sgd/params/to-string' );
...
/**
* Returns a constructor for creating an SGD trainer parameters object.
*
...
function factory( dtype ) {
	...
	/**
	* Returns an SGD trainer parameters object.
	*
	* @private
	* @constructor
	...
	*/
	...
	/**
	* Serializes an SGD trainer parameters object as a string.
	*
	* ## Notes
	*
	* -   Example output:
